...
def generate_training_configuration(opt):
    ...
    opt.run_dir = f"/juice2/scr2/houjun/mppca/runs/{opt.dataset}/{opt.flow}-{opt.base}-{opt.n_factors}-factors"
...
def main(opt):
    ...
    # read in data
    #*******************************************************************************
    data_handler = ImageDataset(dataset=opt.dataset, root_dir="/juice2/scr2/houjun/mppca/data", image_shape=opt.image_shape)
